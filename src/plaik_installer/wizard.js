const I18N = {
  uk: {
    ...
    dbLead: "Оберіть знайдену порожню базу, створіть нову на loopback postgres або введіть існуючу вручну. У цьому релізі PostgreSQL лише 127.0.0.1/localhost.",
    source: "Джерело",
    ...
    doneLead: "Інсталятор вимкнено, токен відкликано. SSH-тунель на порт 8765 можна закрити. Далі відкрийте публічний сайт і control-center.",
  ...
  en: {
    ...
    dbLead: "Use a detected empty database, create one on loopback postgres, or enter an existing loopback database. This release allows PostgreSQL on 127.0.0.1/localhost only.",
    source: "Source",
    ...
    doneLead: "The installer is off and its token is revoked. You can close the SSH tunnel to port 8765. Continue to the public site and control-center.",
